...
test_function(name = "class", args = c("vector_numerico"), index = 1,not_called_msg = "Utiliza la función class() para conocer la clase a la que pertenece un objeto", args_not_specified_msg = "Pasa como argumento el nombre del objeto args[1]", incorrect_msg = "Pasa como argumento a la funcion class el nombre del objeto `vector_numerico")
