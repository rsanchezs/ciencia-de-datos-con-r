...
test_function(name = "class", args = "vector_numerico",eval = FALSE, not_called_msg = "Utiliza la función class() para conocer la clase a la que pertenece un objeto", incorrect_msg = "Pasa como argumento a la funcion class `vector_numerico`"
