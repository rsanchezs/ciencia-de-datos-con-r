...
test_function(name = "class", not_called_msg = "Utiliza la función class() para conocer la clase a la que pertenece un objeto")
check_arg(arg = "vector_numerico", arg_not_specified_msg = "Pasa como argumento a la funcion class el nombre del objeto `vector_numerico`", state = vector_numerico)
